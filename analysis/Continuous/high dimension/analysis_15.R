...
path.cc <- "/nas/longleaf/home/fyy2025/survival_tree_revision/highD/tree_300_50/"
...
for (dataset in 1:num_dataset){
  try(
    {
    train = read_csv(paste0(path.cc,"data/train",(100*(iter-1)+dataset),".csv"))
    test = read_csv(paste0(path.cc,"data/test",(100*(iter-1)+dataset),".csv"))
    structure=TRUE
