...
path.cc <- "/nas/longleaf/home/fyy2025/survival_tree_revision/highD/nl_100_50/data01/"
...
# X[,c(TRUE, FALSE)] = apply(X[,c(TRUE, FALSE),drop=FALSE], 2, function(x) ifelse(x>0,1,0))
# true.lin.pred <- 10*(0.3*X[,1] -0.4*X[,2]+0.3*X[,4] -0.1*X[,6]-0.4*X[,7]+0.25*X[,3]+0.15*X[,8]+0.3*X[,9]-0.2*X[,10])
